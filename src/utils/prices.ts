...
import { CurrencyAmount, Fraction, JSBI, Percent, TokenAmount, Trade, ChainId, ElixirTrade, Pool } from '@pangolindex/sdk'
...
export function computeTradePriceBreakdownOld(
  trade?: Trade,
  chainId?: ChainId
