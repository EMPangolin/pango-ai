...
export const client = new ApolloClient({
  uri: 'https://api.studio.thegraph.com/query/59684/avalanche-pangolin-v3-test/version/latest',//'https://api.studio.thegraph.com/query/59684/avalanche-pangolin-v3-test/version/latest',//
  cache: new InMemoryCache({
    typePolicies: {
      Token: {
