...
import PoolCardV2 from '../../components/earn/PoolCardV2';
...
export default function Earn() {
  ...
  useEffect(() => {
    Promise.all(
      ...
      const poolCards = stakingInfoData.map(stakingInfo => (
        <PoolCardV2 key={stakingInfo.pid} MinichefStakingInfo={stakingInfo} />
      ));
  ...
  return (
    <>
      <PageHeader
        variant="farm"
        title="Pangolin Reward Farming"
        description="Stake Pangolin Liquidity Provider (PGL) token to earn PNG token"
        image={farmImage}
      />
