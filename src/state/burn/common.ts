...
export function useDerivedBurnInfo(
  ...
  const liquidityValue0 =
    token0 && discountedAmount0
      ? TokenAmount.fromRawAmount(unwrappedTokenV3(token0, chainId) as Token, discountedAmount0)
      : undefined;
  const liquidityValue1 =
    token1 && discountedAmount1
      ? TokenAmount.fromRawAmount(unwrappedTokenV3(token1, chainId) as Token, discountedAmount1)
      : undefined;
