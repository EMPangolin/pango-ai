...
//import { useBlockNumber } from '../applicationv3/hooks';
import { Call, MulticallState, parseCallKey, useMulticallAtom } from './atom';
import { useMulticallContractV3 } from '@/hooks/useContract';
...
export default function Updater(): null {
  ...
  const multicallContract = useMulticallContractV3();
  ...
  useEffect(() => {
    ...
    const chunkSize = CALL_CHUNK_SIZE;
